...
echo -e "\033[1;96m   CREAR USUARIO POR TIEMPOS (Minutos)\n\033[1;97mLos Usuarios que crea en esta extención se eliminaran\nautomaticamente pasando el tiempo designado.\033[0m"
msg -bar
...
msg -bar2
echo -e "\033[1;93m ¡¡ USUARIO TEMPORAL x MINUTOS (VPS-GHOST) !!\033[0m"
msg -bar2
