...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/GeneradorVIP/PERU/main/ArchUt/SHADOWSOCK-R/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
