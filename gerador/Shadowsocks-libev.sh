...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/GeneradorVIP/PERU/main/ArchUt/SHADOWSOCK-LIBEV/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
