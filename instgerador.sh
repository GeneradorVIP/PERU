...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0dlbmVyYWRvclZJUC9QRVJVL21haW4vZ2VyYWRvcg=="
SUB_DOM='base64 -d'
rm $(pwd)/$0
...
#echo -e "verificando..."
# check_ip
 permited=$(curl -sSL "https://raw.githubusercontent.com/GeneradorVIP/PERU/main/Control/Control-IP")
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/GeneradorVIP/PERU/main/Install/trans &> /dev/null
